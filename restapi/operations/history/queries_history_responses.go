...
// QueriesHistoryInternalServerErrorCode is the HTTP code returned for type QueriesHistoryInternalServerError
const QueriesHistoryInternalServerErrorCode int = 500

/*
QueriesHistoryInternalServerError Internal Server Error

swagger:response queriesHistoryInternalServerError
*/
type QueriesHistoryInternalServerError struct {
...
// NewQueriesHistoryInternalServerError creates QueriesHistoryInternalServerError with default headers values
func NewQueriesHistoryInternalServerError() *QueriesHistoryInternalServerError {

	return &QueriesHistoryInternalServerError{}
}

// WithPayload adds the payload to the queries history internal server error response
func (o *QueriesHistoryInternalServerError) WithPayload(payload *models.UtilsHTTPError) *QueriesHistoryInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the queries history internal server error response
func (o *QueriesHistoryInternalServerError) SetPayload(payload *models.UtilsHTTPError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *QueriesHistoryInternalServerError) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
